...
| 檔案 | 用途 | 可參考 | 不可直接沿用 |
|---|---|---|---|
| `placement/Screenshot 2026-09-22 165319.png` | SEG-10 女主角走到 placement-creo 風扇旁的比例與站位參考 | 藍色圓柱所表示的女主角尺度、人物與風扇的相對高度、間距及零件間通道位置 | 藍色圓柱的造型、材質、顏色；圖片背景與成片材質；女主角身分仍依角色資產 |
