...
| 檔案 | 用途 | 可參考 | 不可直接沿用 |
|---|---|---|---|
| `placement/Screenshot 2026-09-21 164040.png` | SEG-09 B v03 `<Picture 2>`；船塢內完整 Placement 與最終拉遠構圖基準 | 零件身分、相對比例、間距、位置、輪廓、配色分組、矩形平面方向及高位三分之四觀看方向 | 圖片背景與成片材質；成片轉為船塢內具真實材質、接觸陰影及反射的實體工程零件 |
