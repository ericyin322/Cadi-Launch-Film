...
| 檔案 | 用途 | 可參考 | 不可直接沿用 |
|---|---|---|---|
| `placement/Screenshot 2026-09-22 165319.png` | SEG-10 H3 v02 A `<Picture 2>`、B `<Picture 4>`；風扇形狀、局部 placement、女主角比例與站位參考 | 大型右上風扇的圓角外殼、直線內緣、頂部同心圓、中央凸起圓蓋、薄層側壁、placement 位置與間距；藍色圓柱所表示的人物尺度與通道站位 | 藍色圓柱的造型、材質、顏色；圖片背景與成片材質；女主角身分仍依角色資產；成片轉為直接落位於 Creo 船塢地面的實體工程硬體 |
